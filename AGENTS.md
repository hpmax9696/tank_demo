...
> 3D 坦克对战游戏 | Three.js r160 | v0.79.34 | Codex 协作指引
...
26. **legacy 树镜像修复** - 游戏树 l_/r_ 与工厂树镜像，enemies.js 消费时 rotation y/z 取负（Die 双臂外张隐性 bug 顺带修复）
27. **Gitee 拉取修复** - git schannel 后端 SEC_E_NO_CREDENTIALS，仓库级配置改 openssl 后端
