...
> **当前版本：v0.70.0** | 基于 Three.js 的多模块 3D 浏览器游戏 + 地图编辑器
...
- **空调面**: 窗户对称+空调外机避让窗户(容差0.6u覆盖空调整宽); 天桥子段裁剪
- **架空层柱子**: 内移0.55u+去角柱+清理防泄漏(obstacleMeshes追踪)
- **改动**: js/obstacles.js(+299/-7行) — computeWindowRanges + addDoorsAndWindows + addACToEdge避让
