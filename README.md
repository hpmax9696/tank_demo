...
> **当前版本：v0.24.10** | 基于 Three.js 的多模块 3D 浏览器游戏
...
2. 当前版本 console.log：`🎮 坦克运动demo v0.24.10 | PCFShadow+512+36m跟随 | 四阶段探针 | 遮挡池优化 | 陡视角+FOV 45°`
...
**优化**：阴影类型PCFSoft→PCFShadow+512分辨率+相机36m跟随坦克，渲染从27ms→待验证。
