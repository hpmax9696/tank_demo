...
(function() {
    ...
    function createConicalTree() {
        ...
        g.add(crown);
        g.userData = { height: h, radius: 0.35, color: '#3B7A3B', targetHeightMinM: 3, targetHeightMaxM: 15 };
        addShadow(g);
        return g;
    }
    ...
    function createSphericalTree() {
        ...
        g.add(crown);
        g.userData = { height: h, radius: 0.33, color: '#4A8B3F', targetHeightMinM: 3, targetHeightMaxM: 15 };
        addShadow(g);
        return g;
    }
