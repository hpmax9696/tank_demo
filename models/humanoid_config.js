    ...
    children: [
      {
        ...
        type: 'Box',
        size: [0.3, 0.135, 0.22],
        position: [0, 0.375, 0.04],
        materialId: '__cloth__',
        children: [
          {
            name: 'torso',
            type: 'Group',
            position: [0, 0.0675, 0.04],
            rotation: [0, 0, 0],
            materialId: '__cloth__',
            children: [
              {
              ...
              },
              {
                name: 'neck',
                type: 'Cylinder',
                size: [0.04, 0.061, 0.04],
                position: [0, 0.4745, -0.05],
                rotation: [0, 0, 0],
                pivot: [0, -0.0305, 0],
                materialId: '__skin__',
                children: [
              ...
              },
              {
                name: 'l_upper_arm',
                type: 'Cylinder',
                size: [0.052, 0.275, 0.052],
                position: [0.19, 0.3065, -0.04],
                rotation: [0, 0, 0],
                pivot: [0, 0.1375, 0],
                materialId: '__skin__',
                children: [
                ...
                children: [
                  {
                    name: 'l_foot',
                    type: 'Box',
                    size: [0.112, 0.045, 0.225],
                    position: [0, -0.1571, 0.06],
                    pivot: [0, 0.05, -0.1],
                    materialId: '__skin__',
                    rotation: [0, 0, 0],
                    visible: true,
