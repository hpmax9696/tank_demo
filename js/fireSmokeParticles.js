  ...
  class ExplosionEffects {
    ...
    trigger(pos) {
      ...
      for (let i = 0; i < this.smokeCount; i++) {
        ...
        p.vel.set(Math.cos(angle) * speed, 2.0 + Math.random() * 3.0, Math.sin(angle) * speed);
    ...
    dispose() {
      if (this.firePoints.parent) this.firePoints.parent.remove(this.firePoints);
      if (this.smokePoints.parent) this.smokePoints.parent.remove(this.smokePoints);
      this.fireGeo.dispose();
      this.fireMat.dispose();
      this.smokeGeo.dispose();
      this.smokeMat.dispose();
